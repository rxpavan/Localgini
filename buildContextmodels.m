function [Models,RxnImp] = buildContextmodels(geneExpression,model,MeM,contexts,ut,lt,ThS,coreRxn,filename,varargin)
...
% getting a flux consistent model
cons_mod_rxn_id = fastcc(model,tol);
cons_mod = fastcore(model,cons_mod_rxn_id,tol);
